...
(function (Buffer){
!function(){"use strict";var e=require("http"),t=require("https"),n=require("xp-load"),i=n(require("expandjs"),"XP"),r=n(require("xp-emitter"),"XPEmitter");module.exports=new i.Class("XPRequest",{"extends":r,initialize:{promise:!0,value:function(e,t){i.assertArgument(i.isObject(e)||i.isString(e,!0),1,"Object or string");var n=this;r.call(n),n.options=i.isString(e)?{}:e,n.url=i.isString(e)?e:"",n.chunks=[],n.resolver=t,n.state="idle",n.adapt(),n.adaptee.on("error",n.handleError.bind(n)),n.adaptee.on("response",n.handleResponse.bind(n))}},abort:function(){var e=this;return e.timeAbort?e:(e.adaptee.abort(),e.state="aborted",e.timeAbort=Date.now(),e)},send:function(e){i.assertArgument(i.isVoid(e)||Buffer.isBuffer(e)||i.isString(e,!0),1,"Buffer or string");var t=this;return t.timeSend?t:(t.adaptee.end(e),t.state="pending",t.timeSend=Date.now(),t)},adapt:{enumerable:!1,value:function(){var e=this;return e.adaptee=e.protocol.request(e.url||i.assign({},e.options,{path:i.toURL(e.options.path,e.options.data,!0),port:e.options.port||(e.options.secure?443:80)})),e}},parse:{enumerable:!0,value:function(e){var t=this,n=t.options.dataType;return"json"===n?JSON.parse(e):e}},adaptee:{enumerable:!1,set:function(e){return this.request||e},validate:function(e){return i.isObject(e)}},chunks:{set:function(e){return this.chunks||e},validate:function(e){return i.isArray(e)}},data:{validate:function(e){return i.isString(e)||Buffer.isBuffer(e)}},dataTypes:{frozen:!0,writable:!1,value:["json","text"]},protocol:{enumerable:!1,get:function(){return this.options.secure?t:e}},state:{then:function(e){this.emit("state",e,this)},validate:function(e){return i.includes(this.states,e)}},states:{frozen:!0,writable:!1,value:["aborted","failed","idle","pending","received","receiving"]},timeAbort:{set:function(e){return this.timeAbort||e},validate:function(e){return i.isFinite(e,!0)}},timeData:{set:function(e){return this.timeData||e},validate:function(e){return i.isFinite(e,!0)}},timeResponse:{set:function(e){return this.timeResponse||e},validate:function(e){return i.isFinite(e,!0)}},timeSend:{set:function(e){return this.timeSend||e},validate:function(e){return i.isFinite(e,!0)}},url:{set:function(e){return this.url||e},validate:function(e){return i.isString(e)}},handleData:function(e){var t=this;t.chunks.push(e),t.emit("chunk",e,t)},handleEnd:function(){var e=this;try{e.data=e.parse(Buffer.isBuffer(e.chunks[0])?Buffer.concat(e.chunks):e.chunks.join("")),e.state="received",e.timeData=Date.now()}catch(t){return e.handleError(t.message)}e.resolver(null,e.data),e.emit("data",e.data,e)},handleError:function(e){var t=this;t.state="failed",t.timeResponse=Date.now(),t.timeData=t.timeResponse,t.resolver(e),t.emit("response",t),t.emit("fail",e,t)},handleResponse:function(e){var t=this;t.state="receiving",t.timeResponse=Date.now(),e.on("data",t.handleData.bind(t)),e.on("end",t.handleEnd.bind(t)),t.emit("response",t)}}),i.browserify(module.exports,"XPRequest")}();
}).call(this,require("buffer").Buffer)
