...
(function (global){
!function(e){"use strict";var n=e.XP||_dereq_("expandjs");module.exports=function(e,o){return n.forOwn(e,function(t,i){n.has(o,i)&&o[i].immutable&&delete e[i]}),e}}("undefined"!=typeof window?window:global);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"expandjs":1}],4:[function(_dereq_,module,exports){
(function (global){
!function(t){"use strict";var e=t.XP||_dereq_("expandjs"),i=t.XPEmitter||_dereq_("xp-emitter"),n=_dereq_("./filter"),o=_dereq_("./sanitize"),r=_dereq_("./validate"),a=function(t){return e.has(t,"input")||e.has(t,"options")},s=function(t,i){return t=e.assign({handle:i},t),e.withdraw(t,"method"),t},u=e.freeze(e.keys(r.types)),l=e.freeze(e.filter(e.map(o.sanitizers,s),a)),f=e.freeze(e.filter(e.map(r.validators,s),a));module.exports=t.XPSchema=new e.Class("XPSchema",{"extends":i,initialize:function(t){var e=this;i.call(e),e.options=t,e.fields=e.options.fields||{},e.loose=e.options.loose||!1,e.useful=e.options.useful||!1},filter:{promise:!0,value:function(t,i){var o=this;e.waterfall([function(i){i(!e.isObject(t)&&new e.ValidationError("data","Object",400)||null)},function(i){e.attempt(function(e){e(null,n(t,o.fields,o.options))},i)}],i)}},sanitize:{promise:!0,value:function(t,i){var n=this;e.waterfall([function(i){i(!e.isObject(t)&&new e.ValidationError("data","Object",400)||null)},function(i){e.attempt(function(e){e(null,o(t,n.fields,n.options))},i)}],i)}},validate:{promise:!0,value:function(t,i){var n=this;e.waterfall([function(i){i(!e.isObject(t)&&new e.ValidationError("data","Object",400)||null)},function(i){e.attempt(function(e){e(null,r(t,n.fields,n.options))},i)}],i)}},fields:{validate:function(t){return!e.isObject(t)&&"Object"}},loose:{set:function(t){return!!t}},sanitizers:{"static":!0,get:function(){return l}},types:{"static":!0,get:function(){return u}},useful:{set:function(t){return!!t}},validators:{"static":!0,get:function(){return f}}})}("undefined"!=typeof window?window:global);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
