...
},{"eventemitter3":38,"expandjs":1,"xp-load":39}],38:[function(require,module,exports){
...
},{"./lib":40,"dup":36}],40:[function(require,module,exports){
...
!function(e){"use strict";var t=require("http"),n=require("https"),i=require("xp-load"),r=i(require("expandjs"),"XP"),a=i(require("xp-emitter"),"XPEmitter");module.exports=new r.Class("XPRequest",{"extends":a,options:{dataType:"text",headers:null,keepAlive:0,method:"GET",url:""},initialize:{promise:!0,value:function(e,t){r.assertArgument(r.isObject(e)||r.isString(e,!0),1,"Object or string");var n=this;a.call(n),n.chunks=[],n.options=r.isString(e)?{}:e,n.dataType=n.options.dataType,n.headers=n.options.headers,n.keepAlive=n.options.keepAlive,n.method=n.options.method,n.url=n.options.url,n.resolver=t,n.state="idle",n.adapt(),n.adaptee.on("error",n.handleError.bind(n)),n.adaptee.on("response",n.handleResponse.bind(n))}},abort:function(){var e=this;return e.timeAbort?e:(e.adaptee.abort(),e.state="aborted",e.timeAbort=Date.now(),e)},send:function(e){r.assertArgument(r.isVoid(e)||Buffer.isBuffer(e)||r.isString(e,!0),1,"Buffer or string");var t=this;return t.timeSend?t:(t.adaptee.end(e),t.state="pending",t.timeSend=Date.now(),t)},adapt:{enumerable:!1,value:function(){var i=r.parseURL(this.url),a=r.assign(this,{secure:"https:"===(i.protocol||e.location.protocol)}),s=a.secure?443:80,o=a.secure?n:t;return a.adaptee=o.request({auth:i.auth,headers:a.options.headers||{},hostname:i.hostname||e.location.hostname,keepAlive:a.options.keepAlive>0,keepAliveMsecs:Math.max(a.options.keepAlive,0),method:a.options.method,path:i.path+(i.hash||""),port:a.options.port||i.hostname&&s||e.location.port}),a}},parse:{enumerable:!0,value:function(e){var t=this;return"json"===t.dataType?JSON.parse(e):e}},adaptee:{enumerable:!1,set:function(e){return this.request||e},validate:function(e){return r.isObject(e)}},chunks:{set:function(e){return this.chunks||e},validate:function(e){return r.isArray(e)}},data:{validate:function(e){return r.isString(e)||Buffer.isBuffer(e)}},dataType:{set:function(e){return this.dataType||e},validate:function(e){return r.includes(this.dataTypes,e)}},dataTypes:{frozen:!0,writable:!1,value:["json","text"]},headers:{set:function(e){return this.headers||e},validate:function(e){return r.isObject(e)}},keepAlive:{set:function(e){return this.keepAlive>=0?this.keepAlive:e},validate:function(e){return r.isInt(e,!0)}},method:{set:function(e){return this.method||r.upperCase(e)},validate:function(e){return r.isString(e,!0)}},secure:{set:function(e){return r.isBoolean(this.secure)?this.secure:!!e}},state:{then:function(e){this.emit("state",e,this)},validate:function(e){return r.includes(this.states,e)}},states:{frozen:!0,writable:!1,value:["aborted","failed","idle","pending","received","receiving"]},timeAbort:{set:function(e){return this.timeAbort||e},validate:function(e){return r.isFinite(e,!0)}},timeData:{set:function(e){return this.timeData||e},validate:function(e){return r.isFinite(e,!0)}},timeResponse:{set:function(e){return this.timeResponse||e},validate:function(e){return r.isFinite(e,!0)}},timeSend:{set:function(e){return this.timeSend||e},validate:function(e){return r.isFinite(e,!0)}},url:{set:function(e){return this.url||e},validate:function(e){return r.isString(e)}},handleData:function(e){var t=this;t.chunks.push(e),t.emit("chunk",e,t)},handleEnd:function(){var e=this;try{e.data=e.parse(Buffer.isBuffer(e.chunks[0])?Buffer.concat(e.chunks):e.chunks.join("")),e.state="received",e.timeData=Date.now()}catch(t){return e.handleError(t.message)}e.resolver(null,e.data),e.emit("data",e.data,e)},handleError:function(e){var t=this;t.state="failed",t.timeResponse=Date.now(),t.timeData=t.timeResponse,t.resolver(e),t.emit("response",t),t.emit("fail",e,t)},handleResponse:function(e){var t=this;t.state="receiving",t.timeResponse=Date.now(),e.on("data",t.handleData.bind(t)),e.on("end",t.handleEnd.bind(t)),t.emit("response",t)}}),r.browserify(module.exports,"XPRequest")}("undefined"!=typeof window?window:global);
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer)

},{"buffer":3,"expandjs":1,"http":8,"https":12,"xp-emitter":36,"xp-load":39}],42:[function(require,module,exports){
arguments[4][36][0].apply(exports,arguments)
},{"./lib":41,"dup":36}]},{},[42])
